...
for(peopleHouse of got.houses[1].people){
  console.log(`I am ${peopleHouse.name} and my bio is,${peopleHouse.description}` );
}
...
let infoHouse={};
for(let house of got.houses){
  infoHouse[house.name]=house.people.length;
